# Understand the concept of OOPs by answering these questions
...
Problem: Add a method to the Car class that displays the full name of the car (brand and the model)
</details>
